function exibirMaiorData() {
    ...
    if(dataInput1 > dataInput2){
        alert("data 1 maior data 2");        
    }else if(dataInput2 > dataInput1){
        alert("data 2 maior data 1"); 
    }else
        alert(datas sao iguais);
...
function calcularIntervalo() {
    ...
    if (dataInput1 > dataInput2) {
        ...
        alert( "O intervalo entre as datas é de " + intervalo + " dias.");
    } else {
...
function exibirDataAtual() {
    ...
    alert("Data atual: " + dataAtualFormatada);
}
